const contractAddress = "0x5266B9d8890A348A0717b531Cd1ae60a5c753b8c"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to the throwing up tokens!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The TokensPlease NFT Project is a decentralized, art project that aims to cultivate and curate a generation.  <a href="https://tokensplease.io"  target="_blank" rel="noopener noreferrer">TokensPleaseNFT</a> Discord';
const h1_presale_coming_soon = "Regurgitating Soon";
